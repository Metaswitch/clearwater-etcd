# @file test_dns_config_plugin.py
#
...
from clearwater_etcd_plugins.clearwater_config_manager.dns_config_plugin import DnsConfigPlugin


class TestDnsConfigPlugin(unittest.TestCase):
    ...
    def test_non_default_key_created(self, mock_run_command):
        ...
        # Test assertions
        mock_run_command.assert_called_with("/usr/share/clearwater/bin/reload_dns_config")
