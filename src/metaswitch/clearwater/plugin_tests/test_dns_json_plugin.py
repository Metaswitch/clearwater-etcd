...
from clearwater_etcd_plugins.clearwater_config_manager.dns_json_plugin import DNSJSONPlugin


class TestDNSJSONPlugin(unittest.TestCase):
    ...
    @mock.patch('clearwater_etcd_plugins.clearwater_config_manager.dns_json_plugin.run_command')
    def test_config_changed(self, mock_run_command, mock_safely_write, mock_alarm):
        ...
        with mock.patch('clearwater_etcd_plugins.clearwater_config_manager.dns_json_plugin.open',\
