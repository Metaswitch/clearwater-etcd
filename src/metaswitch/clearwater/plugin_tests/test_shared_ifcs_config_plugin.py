# @file test_shared_ifcs_config_plugin.py
#
...
from clearwater_etcd_plugins.clearwater_config_manager.shared_ifcs_config_plugin import SharedIFCsConfigPlugin


class TestSharedIFCsConfigPlugin(unittest.TestCase):
    @mock.patch('clearwater_etcd_plugins.clearwater_config_manager.shared_ifcs_config_plugin.safely_write')
    @mock.patch('clearwater_etcd_plugins.clearwater_config_manager.shared_ifcs_config_plugin.run_command')
    def test_config_changed(self, mock_run_command, mock_safely_write):
        ...
        # Create the plugin
        plugin = SharedIFCsConfigPlugin(None)
        ...
        with mock.patch('clearwater_etcd_plugins.clearwater_config_manager.shared_ifcs_config_plugin.open',\
        ...
        mock_run_command.assert_called_once_with("/usr/share/clearwater/bin/reload_shared_ifcs_config")
