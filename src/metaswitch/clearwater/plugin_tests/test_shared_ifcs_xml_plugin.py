# @file test_shared_ifcs_xml_plugin.py
#
...
from clearwater_etcd_plugins.clearwater_config_manager.shared_ifcs_xml_plugin import SharedIFCsXMLPlugin


class TestSharedIFCsXMLPlugin(unittest.TestCase):
    ...
    def test_config_changed(self, mock_run_command, mock_safely_write):
        ...
        with mock.patch('clearwater_etcd_plugins.clearwater_config_manager.shared_ifcs_xml_plugin.open',\
